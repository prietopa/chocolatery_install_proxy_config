...
param (
  ...
  Write-Host "Downloading $url to $file"
	...
	#------------ORIGINAL: no proxy configuration ----------------------  
	# $downloader = new-object System.Net.WebClient
	# $downloader.Proxy.Credentials=[System.Net.CredentialCache]::DefaultNetworkCredentials;
	# $downloader.DownloadFile($url, $file)
	#------------Proxy configuration ----------------------  
    $proxy = New-Object System.Net.WebProxy("PROXYSERVER:PORT", $true)
    $passwd = ConvertTo-SecureString "PASS" -AsPlainText -Force; ## Website credentials
    $proxy.Credentials = New-Object System.Management.Automation.PSCredential ("USER", $passwd);
    $downloader = New-Object System.Net.WebCLient
